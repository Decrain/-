...
def file_fill(file_dir):
    for root, dirs, files in os.walk(file_dir):      #扫描该目录下的文件夹和文件，返回根目录路径，文件夹列表，文件列表
        ...
        print(files)
        for f in files:
            tmp_dir = '/Users/decrain/Desktop/dataprocess/sougou_after2' + '/' + f  # 加上标签后的文本  
...
def file_read(file_dir):
    ...
    dicurl = {'auto.sohu.com.cn':'qiche','it.sohu.com':'hulianwang','health.china.com':'jiankang','sports.sina.com.cn':'tiyu',
                'travel.sohu.com':'lvyou','edu.sina.com.cn':'jiaoyu','cul.sohu.com':'wenhua',
                'military.china.com':'junshi','mil.news.sina.com.cn':'junshi','ent.sina.com.cn':'yule','eladies.sina.com.cn':'lady',
                'media.sohu.com':'chuanmei','gongyi.sohu.com':'gongyi','money.163.com':'caijing', 'finance.sina.com.cn': 'shangye'} 
    path = "/Users/decrain/Desktop/dataprocess/sougou_all/"     
            ...
            for index in range(0, len(claimurl)):  
                ...
                if url.hostname in dicurl:  
                   ...
                   # print("1")
                    ...
                    #fp_in = open(path + dicurl[url.hostname] + "/%s.txt" % dicurl[url.hostname] ,"a")
