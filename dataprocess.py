...
def file_fill():
    file_dir = "/Users/decrain/Desktop/未命名文件夹/sougou_before2"
    for root, dirs, files in os.walk(file_dir):
        for f in files:
            tmp_dir = '/Users/decrain/Desktop/未命名文件夹/sougou_after2' + '/' + f #加上标签后的文本
           ...
           # lines = [x.decode('utf8').strip() for x in file_source.readlines()]
...
if __name__ == "__main__":
    ...
    file_fill()
    file_read()
    path = "/Users/decrain/Desktop/未命名文件夹/sougou_all/"
    dicurl = {
